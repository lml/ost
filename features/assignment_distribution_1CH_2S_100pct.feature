...
Feature: Assignments are properly distributed to Students and in Instructor Previews.
    ...
    Background:
        Given assignment distribution 1 Cohort 2 Section 100% setup
    ...
    Scenario: C1S2CH1R Student receives notifications for and can view assignments at the appropriate times.
        Given that I am logged in as "C1S2CH1R Student"
        And   I time travel to "Sep 1, 2012 5:50am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
        ...
        And   under "assignments" I do not see "Homework Three"
        And   under "assignments" I do not see "Homework Four"
        And   there are no emails for "C1S2CH1R Student"
        When  I time travel to "Sep 1, 2012 6:05am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
        ...
        When  I click on "Course One"
        Then  I am taken to the "show" page for "Course One" under "Organization One"
        And   there are emails for "C1S2CH1R Student"
        And   under "assignments" I see "Homework One"
        And   under "assignments" I do not see "Homework Two"
        And   under "assignments" I do not see "Homework Three"
        And   under "assignments" I do not see "Homework Four"
    ...
    Scenario: C1S2CH1A receives notifications for and can view assignments at the appropriate times.
        Given that I am logged in as "C1S2CH1A Student"
        And   I time travel to "Sep 1, 2012 5:50am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
        ...
        And   under "assignments" I do not see "Homework Three"
        And   under "assignments" I do not see "Homework Four"
        And   there are no emails for "C1S2CH1A Student"
        When  I time travel to "Sep 1, 2012 6:05am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
        ...
        When  I click on "Course One"
        Then  I am taken to the "show" page for "Course One" under "Organization One"
        And   there are emails for "C1S2CH1A Student"
        And   under "assignments" I see "Homework One"
        And   under "assignments" I do not see "Homework Two"
        And   under "assignments" I do not see "Homework Three"
        And   under "assignments" I do not see "Homework Four"
    ...
    Scenario: C1S2CH1D receives no notifications for and cannot view assignments.
        Given that I am logged in as "C1S2CH1D Student"
        And   I time travel to "Sep 1, 2012 5:50am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
        ...
        And   under "assignments" I do not see "Homework Three"
        And   under "assignments" I do not see "Homework Four"
        And   there are no emails for "C1S2CH1D Student"
        When  I time travel to "Sep 1, 2012 6:05am" "UTC"
        Given that there are no emails
        When  cron jobs have been run
        When  I visit the main page
