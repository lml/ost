class AddDefaultPcFcToLc < ActiveRecord::Migration
  ...
  def up
    ...
    add_index :learning_condition_default_feedback_conditions, [:learning_condition_id], name: "index_lcdpcs_on_lc_id_scoped", unique: true
    ...
    LearningCondition.find_each do |lc|
      ...
      LearningConditionDefaultFeedbackCondition.create! do |lcdfc|
        ...
        lcdfc.presentation_condition_id = dfc.id
      end
    end
  end
